...
@JsonPropertyOrder(value = {DiscoveryConst.COMPANY_NAME, DiscoveryConst.ADDRESS_LINE_1, DiscoveryConst.ADDRESS_LINE_2, DiscoveryConst.ADDRESS_LINE_3,
        ...
        DiscoveryConst.BPS_AVAILABLE, DiscoveryConst.CARD_ACCEPTANCE, DiscoveryConst.RESTRICTIONS, DiscoveryConst.CONFIDENCE, DiscoveryConst.TRACK_ID, DiscoveryConst.TRACK_SCORE, DiscoveryConst.TRACK_BUSINESSNAME,
        DiscoveryConst.TRACK_STREET_ADDRESS, DiscoveryConst.TRACK_CITY, DiscoveryConst.TRACK_STATE, DiscoveryConst.TRACK_ZIP})
@Getter
@Setter
@NoArgsConstructor
public class DiscoveryModelSupplier implements Serializable, Model {
