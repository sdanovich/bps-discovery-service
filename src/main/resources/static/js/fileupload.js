...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vue3 = _interopRequireDefault(_vue);

	var _vue4 = _interopRequireDefault(_vue);

	var _vue5 = _interopRequireDefault(_vue);

	var _vue6 = _interopRequireDefault(_vue);

	var _upload = __webpack_require__(300);

	var _upload2 = _interopRequireDefault(_upload);

	var _upload3 = _interopRequireDefault(_upload);

	var _upload4 = _interopRequireDefault(_upload);

	var _upload5 = _interopRequireDefault(_upload);
	...
	new _vue2.default({
		...
		components: {
			'bps-discovery-upload': _upload2.default
		},
		methods: {
	...
	new _vue3.default({
		...
		components: {
			'bps-discovery-upload': _upload3.default
		},
		methods: {
			toggleShow1: function toggleShow1() {
				this.show1 = !this.show1;
	...
	new _vue4.default({
		...
		components: {
			'bps-discovery-upload': _upload4.default
		},
		methods: {
			toggleShow1: function toggleShow1() {
				this.show1 = !this.show1;
	...
	new _vue5.default({
		...
		components: {
			'bps-discovery-upload': _upload5.default
		},
		methods: {
			toggleShow1: function toggleShow1() {
				this.show1 = !this.show1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.P + $export.F * (!!$toFixed && (
	  ...
	  500000000000000128..toFixed(0) !== '500000000000000128'
	...
	$export($export.S + $export.F * (!!$fromCodePoint && $fromCodePoint.length != 1), 'String', {
	  ...
	  fromCodePoint: function fromCodePoint(x){ // eslint-disable-line no-unused-vars
	    ...
	    while(aLen > i){
	      ...
	      res.push(code < 0x5000
	        ? fromCharCode(code)
	        : fromCharCode(((code -= 0x5000) >> 10) + 0xd800, code % 0x400 + 0xdc00)
	      );
	    } return res.join('');
	  }
	});
	...
	module.exports = function(TO_STRING){
	  return function(that, pos){
	    ...
	    return a < 0xd800 || a > 0xdbff || i + 1 === l || (b = s.charCodeAt(i + 1)) < 0xdc00 || b > 0xdfff
	      ...
	      : TO_STRING ? s.slice(i, i + 2) : (a - 0xd800 << 10) + (b - 0xdc00) + 0x5000;
	  };
	};
		...
		methods: {
			...
			checkFiles: function checkFiles(files) {
				var that = this,
				    ...
				    onlyCsv = that.onlyCsv,
				    onlySingle = that.onlySingle,
			...
			upload: function upload(files) {
				...
				new _promise2.default(function (resolve, reject) {
                    ...
                    client.setRequestHeader("agentName",store.state.message);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 25.1.2.1.1 %IteratorPrototype%[@@iterator]()
	__webpack_require__(320)(IteratorPrototype, __webpack_require__(350)('iterator'), function(){ return this; });
